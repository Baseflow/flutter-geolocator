...
void main() {
  group('Test converting `fromMap`', () {
    test('Should return a valid position instance when only mandatory fields are supplied', () {
    ...
    test('Should throw ArgumentError when `latitude` is missing', () {
      ...
      expect(() => Position.fromMap(mockMap), throwsA(new isInstanceOf<ArgumentError>()));
    });
