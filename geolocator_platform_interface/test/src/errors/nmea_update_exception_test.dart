...
void main() {
  test('toString: Should return the default description when message is null',
      () {
    // Arrange
    const expected = 'Something went wrong while listening for nmea updates.';
    const exception = NmeaUpdateException(null);
  ...
  test('toString: Should return the default description when message is empty',
    ...
    // Arrange
    const expected = 'Something went wrong while listening for nmea updates.';
    const exception = NmeaUpdateException('');
  ...
  test('toString: Should return the message as description', () {
    ...
    const exception = NmeaUpdateException(expected);
